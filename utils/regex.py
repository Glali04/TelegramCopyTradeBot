import re
#it will only track solana addresses, there is the most trade (for my bot eth transactions would be to expensive, other blockchains is not that active to worth looking them)
